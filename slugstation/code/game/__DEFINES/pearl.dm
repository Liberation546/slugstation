...
#define WHITE_PEARL_LORE list({"
	...
	SAY "} + pick(
		...
		"}
		{"
		This is an official decree of cultivation sent from the twenty-second Subsistence Council ordering the eastern spoke Farm Array administration to "immediately harvest and process all viable crops, despite whatever misgivings they might have." A short-sighted endeavor for sure.
		DELAY 20
		...
		DELAY 20
		SAY To place shadow upon the Divine Body of the True Anointed Citadel is outrageous blasphemy and cannot be tolerated, no matter the circumstances..." Clearly this was ignored.
		"}
		{"
		...
		DELAY 20
		SAY We iterators were built for pragmatism, so it is an understatement to DELAY 20
		SAY that we were not known for our appreciation of beauty...
		DELAY 20
		...
		"}
		{"
		"...through the mists of memory, your image dances, like the motes of dust, in a ray of sunlight, that pierces a dark room." A line of verse from the ancient farmer-poet Pel.
		DELAY 20
		SAY Very dreary if you ask me.
		"}
		{"
		"Fifteen stems of sun bark, hydrolyzed.
		DELAY 20
		SAY Twelve to nineteen bushels of atomized chalk powder.
		DELAY 20
		SAY Assorted Root vegetation..." It goes on and on.
		DELAY 20
		...
		It\'s a...
		DELAY 20
		SAY recipe of some kind? "Two parts rot bar extract, one part bone ash." Nothing I recognize.
		"}
		{"
		An image...
		DELAY 20
		SAY of five bottles, standing on a surface made of...
		DELAY 20
		SAY plants? I have no idea what this is.
		"}
		{"
		...
		DELAY 20
		SAY I honestly can't fathom how they achieve this with their primitive level of technology! Fascinating.
		"}
		{"
