/datum/action/item_action/mod
	...
	icon_icon = 'slugstation/icons/mob/actions/actions_mod.dmi'
...
/datum/action/item_action/mod/pinned_module/ApplyIcon(atom/movable/screen/movable/action_button/current_button, force)
	...
	if(module == mod.selected_module)
		current_button.add_overlay(image(icon = 'slugstation/icons/hud/radial.dmi', icon_state = "module_selected", layer = FLOAT_LAYER-0.1))
	else if(module.active)
		current_button.add_overlay(image(icon = 'slugstation/icons/hud/radial.dmi', icon_state = "module_active", layer = FLOAT_LAYER-0.1))
	if(!COOLDOWN_FINISHED(module, cooldown_timer))
		var/image/cooldown_image = image(icon = 'slugstation/icons/hud/radial.dmi', icon_state = "module_cooldown")
