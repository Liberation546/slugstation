/obj/item/dark_bible
	...
	icon = 'slugstation/icons/obj/apostle.dmi'
	...
	if(proximity_flag && ishuman(target))
		if(user != target)
			if(uses > 0 && audio_cd < world.time)
				...
				playsound(src, 'slugstation/sound/lcorp/apostle_antag/whisper.ogg', 50, 1)
...
/obj/item/clothing/suit/armor/apostle
	...
	icon = 'slugstation/icons/mob/clothing/apostle.dmi'
	mob_overlay_icon = 'slugstation/icons/mob/clothing/apostle.dmi'
	icon_state = "apostlearmor"
	item_state = "apostlearmor"
	item_flags = DROPDEL
	heat_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	armor = list(BRUTE = 70, BOMB = 100, BIO = 100, RAD = 100, FIRE = 100, ACID = 95, WOUND = 50)
...
/obj/item/clothing/mask/gas/apostle
	...
	item_state = "apostlemask"
	item_flags = DROPDEL
	visor_flags = BLOCK_GAS_SMOKE_EFFECT | MASKINTERNALS
	visor_flags_inv = HIDEFACIALHAIR
	visor_flags_cover = MASKCOVERSMOUTH
	armor = list(BRUTE = 70, BOMB = 100, BIO = 100, RAD = 100, FIRE = 100, ACID = 95, WOUND = 200)
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/mask/gas/apostle/guardian
	...
	item_state = "apostlemask_guardian"
...
/obj/item/nullrod/scythe/apostle
	...
	item_state = "ap_scythe"
	lefthand_file = 'slugstation/icons/mob/inhands/apostle_left.dmi'
	righthand_file = 'slugstation/icons/mob/inhands/apostle_right.dmi'
	icon = 'slugstation/icons/obj/apostle.dmi'
	name = "holy scythe"
	desc = "None shall harm us."
	hitsound = 'slugstation/sound/lcorp/apostle_antag/scythe.ogg'
	force = 45
...
/obj/item/nullrod/scythe/apostle/attack_self(mob/living/carbon/user)
	...
	user.emote("spin")
	user.emote("flip")
	playsound(src, 'slugstation/sound/lcorp/apostle_antag/scythe_spell.ogg', 150, 1)
...
/obj/item/nullrod/scythe/apostle/guardian/light/attack_hand(mob/living/user)
	if(!bound && !(faction_needed in user.faction))
		...
		SEND_SOUND(user, 'slugstation/sound/lcorp/apostle_bell.ogg')
...
/obj/item/gun/magic/staff/apostle/process_fire(atom/target, mob/living/user, message = TRUE, params = null, zone_override = "", bonus_spread = 0)
	...
	playsound(src, 'slugstation/sound/lcorp/apostle_antag/staff_charge.ogg', 100, 1)
...
/obj/item/ammo_casing/magic/arcane_barrage/apostle
	projectile_type = /obj/item/projectile/magic/arcane_barrage/apostle

/obj/item/projectile/magic/arcane_barrage/apostle
	damage = 20
	damage_type = BRUTE
	flag = MAGIC

/obj/item/projectile/magic/arcane_barrage/apostle/on_hit(target)
	if(ismob(target))
		var/mob/H = target
		if("apostle" in H.faction)
...
/obj/item/nullrod/spear/apostle
	...
	icon_state = "ap_spear"
	item_state = "ap_spear"
	hitsound = 'slugstation/sound/lcorp/apostle_antag/spear.ogg'
	...
	armour_penetration = 0
	sharpness = SHARP_NONE
	attack_verb = list("attacks", "impales", "pierces", "tears", "lacerates", "gores")
	var/dash_distance = 6
...
/obj/item/nullrod/spear/apostle/attack_self(mob/living/carbon/user)
	...
	playsound(src, 'slugstation/sound/lcorp/apostle_antag/spear_charge.ogg', 100, 1)
	if(!do_after(user, 25))
		return
	recharge_time = (world.time + recharge_time_base) // The real cooldown
	user.forceMove(final_T)
	playsound(src, 'slugstation/sound/lcorp/apostle_antag/spear_dash.ogg', 100, 1)
...
/datum/outfit/apostle_heretic
	...
	uniform = /obj/item/clothing/under/suit_jacket/burgundy // Mostly for admin spawn and when apostle was dead without any items.
